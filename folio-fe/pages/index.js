        ...
        <section className={`${styles.section} ${styles.sectionEven}`}>
          <div className={"container mx-auto"}>
            ...
            <div className={styles.entry}>
              ...
              <div className={styles.entryContainer}>
                <div className={styles.entryHeadContainer}>
                  <h3 className={styles.entryHeading1}>The University of Queensland</h3>
                  <h4 className={styles.entryHeading2}>Bachelor of Computer Science, GPA: 7.00/7.00</h4>
                </div>
                <div className={styles.entryBodyContainer}>
                  <p className={styles.entryHeadingSub1}>Feb 2020 – present</p>
                  <p className={styles.entryHeadingSub1}>Brisbane, QLD, Australia</p>
                  <ul className={"list-disc"} style={{paddingLeft: 20}}>
                    <li>Majoring in data science</li>
                    <li>Scholarship recipient for outstanding academic achievements</li>
            ...
            <div className={styles.entry}>
              ...
              <div className={styles.entryContainer}>
                <div className={styles.entryHeadContainer}>
                  <h3 className={styles.entryHeading1}>Universitas Indonesia</h3>
                  <h4 className={styles.entryHeading2}>Bachelor of Computer Science, GPA: 3.99/4.00</h4>
                </div>
                <div className={styles.entryBodyContainer}>
                  <p className={styles.entryHeadingSub1}>Jul 2017 – present</p>
                  <p className={styles.entryHeadingSub1}>Jakarta, Indonesia</p>
                  <ul className={"list-disc"} style={{paddingLeft: 20}}>
                    <li>Double degree also in Computer Science with The University of Queensland</li>
                  </ul>
                </div>
              </div>
            </div>
        ...
        <section className={`${styles.section} ${styles.sectionOdd}`}>
          <div className={"container mx-auto"}>
            ...
            <div className={styles.entry}>
              ...
              <div className={styles.entryContainer}>
                <div className={styles.entryHeadContainer}>
                  ...
                  <h4 className={styles.entryHeading2}>HappyFresh, Part-time</h4>
                </div>
                <div className={styles.entryBodyContainer}>
                  <p className={styles.entryHeadingSub1}>Sep 2019 – Dec 2019, 4 months</p>
                  <p className={styles.entryHeadingSub1}>Jakarta, Indonesia</p>
                  <ul className={"list-disc"} style={{paddingLeft: 20}}>
                    <li>A part of a course in Universitas Indonesia</li>
                    <li>Developed Fleet Tracker service to track customer orders in real-time</li>
                    <li>Advanced coordinate interpolation with Kalman filters are utilized to help reduce GPS usage load on the courier's mobile devices</li>
                    <li>Location stream retrieved from ActiveMQ managed by HappyFresh</li>
                    <li>Golang back-end and JS/React front-end with WebSocket communication</li>
                    <li>Automated deployment using Docker containers to AWS EC2 via GitLab CI</li>
                  </ul>
                </div>
              </div>
            </div>
            <div className={styles.entry}>
              ...
              <div className={styles.entryContainer}>
                <div className={styles.entryHeadContainer}>
                  ...
                  <h4 className={styles.entryHeading2}>Shopee, Full-time Intern</h4>
                </div>
                <div className={styles.entryBodyContainer}>
                  <p className={styles.entryHeadingSub1}>May 2019 – Aug 2019, 4 months</p>
                  <p className={styles.entryHeadingSub1}>Singapore</p>
                  <ul className={"list-disc"} style={{paddingLeft: 20}}>
                    <li>Developed an adaptive versioning deployment system for Shopee's website across 7 countries, integrating with the on-premise GitLab</li>
                    <li>Developed an automatic remote profiling system for the Golang-based services</li>
                    <li>Developed a voting system for use within the mobile application to support tenants' requirements</li>
                    <li>Mostly developed using Golang back-end, automatically deployed into Kubernetes cluster</li>
                  </ul>
                </div>
              </div>
            </div>
            <div className={styles.entry}>
              ...
              <div className={styles.entryContainer}>
                <div className={styles.entryHeadContainer}>
                  ...
                  <h4 className={styles.entryHeading2}>Pusat Ilmu Komputer Universitas Indonesia, Part-time</h4>
                </div>
                <div className={styles.entryBodyContainer}>
            ...
            <div className={styles.entry}>
              ...
              <div className={styles.entryContainer}>
                <div className={styles.entryHeadContainer}>
                  <h3 className={styles.entryHeading1}>Teaching Assistant Coordinator</h3>
                  <h4 className={styles.entryHeading2}>Universitas Indonesia</h4>
                </div>
                <div className={styles.entryBodyContainer}>
            ...
            <div className={styles.entry}>
              ...
              <div className={styles.entryContainer}>
                <div className={styles.entryHeadContainer}>
                  <h3 className={styles.entryHeading1}>Autonomous Rocket Research System Programmer</h3>
                  <h4 className={styles.entryHeading2}>Tim Robotika Universitas Indonesia</h4>
                </div>
                <div className={styles.entryBodyContainer}>
                  <p className={styles.entryHeadingSub1}>Mar 2018 – Jun 2019, 1 year 4 months</p>
                  <p className={styles.entryHeadingSub1}>Jakarta, Indonesia</p>
                </div>
              </div>
            </div>
